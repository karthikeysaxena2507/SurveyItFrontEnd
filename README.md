Front End of a web application for conducting surveys and polls. It is Built with Reactjs, CSS/Bootstrap and Html. The Frontend is deployed on Netlify. Live version:
